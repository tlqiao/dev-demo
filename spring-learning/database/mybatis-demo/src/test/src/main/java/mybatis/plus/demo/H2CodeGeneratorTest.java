...
public class H2CodeGeneratorTest extends BaseGeneratorTest {
    ...
    private static final DataSourceConfig DATA_SOURCE_CONFIG = new DataSourceConfig
            .Builder("jdbc:h2:mem:test;DB_CLOSE_DELAY=-1;DB_CLOSE_ON_EXIT=FALSE;DATABASE_TO_UPPER=FALSE;MODE=MYSQL", "sa", "")
    ...
    public void testCustomTemplatePath() {
        ...
        pathInfo.put(OutputFile.xml, "//Users//taoli//code");
        pathInfo.put(OutputFile.entity, "//Users//taoli//code//entity/");
        AutoGenerator generator = new AutoGenerator(DATA_SOURCE_CONFIG);
        generator.strategy(strategyConfig().build());
