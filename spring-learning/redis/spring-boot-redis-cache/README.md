...
#### How to Run the demo
###### 1.install mysql and create database "redisDemo"
###### 2.change to your own mysql user and password,start application
###### 3.use postman to call post method "http://localhost:8080/customers", to add some customer to db
###### 4.call get method "http://localhost:8080/customers", first time, it around take several seconds, it only takes several ms later until it exceed redis cache timeout
